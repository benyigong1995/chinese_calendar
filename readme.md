...
这是一个基于 Python 的多功能工具，包含中国传统历法显示、中美税收计算功能、健康体重计算等功能。
...
| 项目     | 男性        | 女性        |
+==========+=============+=============+
| 肌肉重量 | 29.7-30.4kg | 21.4-22.0kg |
+----------+-------------+-------------+
| 骨骼重量 | 8.9-9.1kg   | 6.3-6.4kg   |
+----------+-------------+-------------+
| 器官重量 | 12.5-12.8kg | 12.0-12.3kg |
+----------+-------------+-------------+
```
...
- 体重系数随身高非线性变化
- 适用于150-190cm的身高范围
- 结果仅供参考，实际健康体重会因个体差异、运动习惯等因素而变化
